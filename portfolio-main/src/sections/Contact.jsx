...
const socials = [
  ...
  { name: "Email", icon: Mail, href: PORTFOLIO_INFO.webmail },
];
      ...
      >
        ...
        >
          ...
          <p className="text-white/50 text-lg font-light max-w-lg mx-auto mb-10">
            Got a project in mind or just want to connect? Feel free to reach out via email or connect on LinkedIn and GitHub.
          </p>

          {/* CTA Button */}
          <motion.a
            href={PORTFOLIO_INFO.webmail}
            target="_blank"
      ...
      <footer className="px-4 md:px-8 py-8 border-t border-white/[0.04]">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-white/30 text-sm">
            © 2026 SS NAVYA. All rights reserved.
          </p>
